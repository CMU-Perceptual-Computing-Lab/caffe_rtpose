...
void DataTransformer<Dtype>::Transform_bottomup(const Datum& datum, Dtype* transformed_data, Dtype* transformed_label, int cnt) {
  ...
  Mat nullmat;
  if(0 && param_.visualize()) 
    visualize(img, meta, as, NULL, nullmat);
