...
template<typename Dtype> void DataTransformer<Dtype>::Transform_cocobottomup(const Datum& datum, Blob<Dtype>* transformed_data, Blob<Dtype>* transformed_label, int cnt) {
  ...
  Transform_cocobottomup(datum, transformed_data_pointer, transformed_label_pointer, cnt); //call function 1
}


template<typename Dtype> void DataTransformer<Dtype>::Transform_cocobottomup(const Datum& datum, Dtype* transformed_data, Dtype* transformed_label, int cnt) {
