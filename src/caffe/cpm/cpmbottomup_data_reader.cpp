...
map<const string, weak_ptr<CPMBottomUpDataReader::Body> > CPMBottomUpDataReader::bodies_;
...
CPMBottomUpDataReader::~CPMBottomUpDataReader() {
...
CPMBottomUpDataReader::QueuePair::QueuePair(int size) {
...
CPMBottomUpDataReader::QueuePair::~QueuePair() {
  Datum* datum;
...
CPMBottomUpDataReader::Body::Body(const LayerParameter& param)
    : param_(param),
      new_queue_pairs_() {
  StartInternalThread();
}

CPMBottomUpDataReader::Body::~Body() {
  StopInternalThread();
}
