...
# MPI
[[ ! -f mpi/pose_iter_264000.caffemodel ]] && wget http://posefs1.perception.cs.cmu.edu/Users/tsimon/Projects/coco/data/models/coco/pose_iter_440000.caffemodel -P mpi/   
